...
//		}
		...
		params.setParameter ( "http.connection.timeout", new Integer ( CONNECTION_TIMEOUT ) );
		params.setParameter ( "http.protocol.content-charset", "UTF-8" );
		//setHttpclient ( new DefaultHttpClient ( mgr, params ) );
	 ...
	 */
	public TwilioRestResponse request ( final String path, final String method, final Map < String, String > paramMap ) throws TwilioRestException
	{
	...
	public TwilioRestResponse request ( final String path, final String method, final List < NameValuePair > paramList ) throws TwilioRestException
	{
	...
	private HttpUriRequest setupRequest ( String path, final String method, final List < NameValuePair > params )
	{
		...
		{ // as DefaultHttpClient class has final method, I need httpClient to
			// be a plain interface to be able to mock it
			( ( DefaultHttpClient ) httpclient ).getCredentialsProvider ().setCredentials ( new AuthScope ( AuthScope.ANY_HOST, AuthScope.ANY_PORT ), new UsernamePasswordCredentials ( accountSid, authToken ) );
		}
		return request;
	}
	 ...
	 */
	public TwilioRestResponse safeRequest ( final String path, final String method, final Map < String, String > vars ) throws TwilioRestException
	{
	 ...
	 *             if there's an client exception returned by the TwilioApi
	 */
	public TwilioRestResponse safeRequest ( final String path, final String method, final List < NameValuePair > paramList ) throws TwilioRestException
	{
	 ...
	 * {@link <a href="https://www.twilio.com/docs/api/rest/account">https://www.twilio.com/docs/api/rest/account</a>}
	 * 
	 * @param params
