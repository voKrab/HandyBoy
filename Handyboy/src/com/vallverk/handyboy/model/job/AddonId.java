...
public interface AddonId
{
	...
	int BATHING_SUIT_2 = SHIRTLESS_6 + 1;
	...
	int BRIEFS = BOXERS + 1;
	int JOCKSTRAP = BRIEFS + 1;
	int GYM = JOCKSTRAP + 1;
	int SHIRTLESS_7 = GYM + 1;									// 30
	int OTHER_LOCATION = SHIRTLESS_7 + 1;						// 31
	...
	//masseur
	int WHAT_TYPE_OF_MASSAGE_DO_YOU_OFFER = SHIRTLESS_10 + 1;	// 36
	int SWEDISH = WHAT_TYPE_OF_MASSAGE_DO_YOU_OFFER + 1;		// 37
	int DEEP_TISSUE = SWEDISH + 1;
	int NON_THERAPEUTIC = DEEP_TISSUE + 1;
	int COMBINATION = NON_THERAPEUTIC + 1;
	int HOT_STONE = COMBINATION + 1;
	int SPORTS = HOT_STONE + 1;
	int THAI = SPORTS + 1;
