...
import com.vallverk.handyboy.view.base.rangeslider.Thumb.ThumbType;
...
public class RangeBar extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mLeftThumb = new Thumb(ctx,
                               ...
                               mThumbRadiusDP,
                               mThumbImageNormal,
                               mThumbImagePressed, thumbType, mLeftIndex + mMin);
        mRightThumb = new Thumb(ctx,
                                ...
                                mThumbRadiusDP,
                                mThumbImageNormal,
                                mThumbImagePressed, thumbType ,  mRightIndex + mMin);
    ...
    public void setMaxMin(int max, int min){
    	mMax = max;
    	mMin = min;
    	setTickCount(mMax - mMin + 1);
    }
    
    public int getRightValue(){
    	return mRightIndex + mMin;
    }
    
    public int getLeftValue(){
    	return mLeftIndex + mMin;
    }
    ...
    public void setThumbIndices(int leftThumbIndex, int rightThumbIndex)
    {
       ...
       // } else {
            ...
            mLeftIndex = leftThumbIndex - mMin;
            mRightIndex =  rightThumbIndex - mMin;
            createThumbs();
            
            if (mListener != null) {
                mListener.onIndexChangeListener(this, mLeftIndex, mRightIndex);
            }
            mLeftThumb.setTrumbIndex(mLeftIndex);
            mRightThumb.setTrumbIndex(mRightIndex);
        //}
    ...
    private void rangeBarInit(Context context, AttributeSet attrs)
    {
        ...
        try {
            ...
            thumbType =  ThumbType.values ()[ ta.getInteger ( R.styleable.RangeBar_thumbType, 0 )];
    ...
    private void onActionMove(float x) {
        ...
        if (newLeftIndex != mLeftIndex || newRightIndex != mRightIndex) {
            ...
            mLeftThumb.setTrumbIndex(mLeftIndex + mMin);
            mRightThumb.setTrumbIndex(mRightIndex + mMin);
