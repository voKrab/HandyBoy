...
package com.vallverk.handyboy.view.base.wheel;
...
import com.vallverk.handyboy.view.base.wheel.adapters.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
    ...
    private void doScroll(int delta) {
        ...
        int currentPosition = mCurrentItemIdx - count;
        ...
        if (mIsCyclic && itemCount > 0) {
            ...
            } else if (currentPosition > 0 && fixPos > 0) {
                currentPosition--;
                count++;
            } else if (currentPosition < itemCount - 1 && fixPos < 0) {
                currentPosition++;
                count--;
            }
        }
        ...
        if (currentPosition != mCurrentItemIdx) {
