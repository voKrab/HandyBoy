...
public class ServerManager
{
    ...
    public static final String SAVE_BANK_ACCOUNT = PROTOCOL + HOST  + "/payment/bankaccount";
    public static final String UPDATE_BANK_ACCOUNT = PROTOCOL + HOST  + "/payment/updatebankaccount";
