...
//			int dHeight = (int) (imageDrawable.getIntrinsicHeight() * 1.2);
//			int dWidth = (int) (imageDrawable.getIntrinsicWidth() * 1.2);
			...
			int newsSize = Math.max(dHeight, dWidth);
			System.out.println( lp.width + " " + lp.height + " " + newsSize);
			lp.width = lp.height = newsSize;
